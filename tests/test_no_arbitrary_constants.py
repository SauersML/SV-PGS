...
REGISTRY: dict[tuple[str, str], tuple[str, frozenset[object], str]] = {
    ...
    ('exact_marginals_scale.py', 'FORMATION_ROUNDINGS'): ('definitional', frozenset({5}), 'roundings in one formed product D_j xt_ij xt_kj (sqrt, two scalings, product) plus its addition into K; Higham 2002 section 3.1'),
    ('exact_marginals_scale.py', 'VARIANCE_OPERATIONS'): ('definitional', frozenset({3}), 'floating-point operations in D (1 - D v): product, difference, scaling; Higham 2002 section 3.1'),
