...
REGISTRY: dict[tuple[str, str], tuple[str, frozenset[object], str]] = {
    ...
    ('marginal_variances.py', 'window_working_bytes'): ('derived', frozenset({3, 4}), "byte accounting of the window algebra's arrays: the number of simultaneously live |W| x |W| (3) and |W| x |b| (4) arrays"),
