...
REGISTRY: dict[tuple[str, str], tuple[str, frozenset[object], str]] = {
    ...
    ('synthetic_store.py', 'SINGLE_PATH_R2'): ('scenario', frozenset({0.9993807168084469, 0.9995432413348173, 0.9995579609235608, 0.9999271445811645, 0.9964503289666373, 0.9904424356321783, 0.9841285595217206, 0.9935772481102674, 0.0016979617415352956, 0.23722189293162207, 0.7358563137729425, 0.8934057700263954, 0.15209710871018542, 0.38899596478651394, 0.7046636717650798, 0.9180855987022858}), 'bench-sim GLIMPSE2 arm median single-record dosage r2 on public 1kGP haplotypes (results_calibration_2000.json)'),
    ('synthetic_store.py', 'MAF_BIN_EDGES'): ('scenario', frozenset({0.001, 0.01, 0.05}), 'the MAF bin edges of bench-sim GLIMPSE2 arm median single-record dosage r2 on public 1kGP haplotypes (results_calibration_2000.json)'),
