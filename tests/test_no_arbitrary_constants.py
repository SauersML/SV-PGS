...
REGISTRY: dict[tuple[str, str], tuple[str, frozenset[object], str]] = {
    ...
    ('scale_mixture_ep.py', '_HELD_ARRAYS_PER_ROW_SET'): ('definitional', frozenset({11}), 'the p x K arrays one held _KernelRows set keeps: its six forms and the four derivatives once formed'),
