...
REGISTRY: dict[tuple[str, str], tuple[str, frozenset[object], str]] = {
    ...
    ('scale_mixture_ep.py', '_stationarity_check'): ('derived', frozenset({3.0, 6.0}), 'optimal central-difference step (3 eps |V| / |V\'\'\'|)^(1/3): truncation h^2 V\'\'\'/6 against rounding eps |V| / h'),
