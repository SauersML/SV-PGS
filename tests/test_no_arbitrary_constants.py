...
REGISTRY: dict[tuple[str, str], tuple[str, frozenset[object], str]] = {
    ...
    ('scale_mixture_ep.py', '_correction_gradient'): ('math', frozenset({6.0}), 'polarization of a symmetric trilinear form: T(u, u, v) = (T(u + v) - T(u - v) - 2 T(v)) / 6'),
    ('scale_mixture_ep.py', '_correction_gradient.integrand'): ('definitional', frozenset({3}), "the line density's moments of order 0, 1 and 2 beside the slopes"),
