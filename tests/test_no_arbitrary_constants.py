...
REGISTRY: dict[tuple[str, str], tuple[str, frozenset[object], str]] = {
    ...
    ('scale_mixture_ep.py', 'fit_hyperparameters.segment_reach'): ('math', frozenset({2.0, 4.0}), 'the maximum of the quadratic model s f + c f^2 with c < 0 is s^2 / (4 |c|), at f = s / (2 |c|)'),
