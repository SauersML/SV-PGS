...
This assumes your genotype files are in your home directory as `arrays.bed`, `arrays.bim`, and `arrays.fam`. The phenotype step uses the active All of Us workspace dataset from `WORKSPACE_CDR`.
