...
under-cover at small K. Mixture posteriors instead use empirical draw quantiles.
The predictive also carries the conditional covariate means for these same
draws and the conditional covariate covariance, preserving their dependence.
