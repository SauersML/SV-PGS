...
covariates, main's harness.genetic_accuracy). The SV-PGS reference is the first of svpgs_v5, svpgs_v4, svpgs_v2, svpgs_main, svpgs_full that exists.
...
for scenario in sys.argv[1].split(","):
    ...
    reference = next((LEAD / name / f"scenario_{scenario}" / "prediction.npz" for name in ("svpgs_v5", "svpgs_v4", "svpgs_v2", "svpgs_main", "svpgs_full")
